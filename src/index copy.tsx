...
import { genConfig, defaultOptions, adjustColor } from "./utils";
    ...
    <div className="body">
      ...
      <div className="playground">
        ...
        <div className="playground-editor">
          ...
          <p>Placers</p>
          <p>
            First select with corner or arm you'd like the object to be placed
          </p>
          <div className="playground-editor__upper">
        ...
        {/* <input value={position} type="text" onChange={handleChange}></input> */}
      </div>
    </div>
  );
};
